      ...
      <div className="projectClassContainer">
          ...
          <div className="project-details">
            ...
            <div className="control">
              ...
              <button className="btn">
                ...
                >
                  {" "}
                  <span className="buy">Github</span>
                </a>
              </button>
            </div>
          </div>
        ...
        <div id="container">
          <div className="project-details">
            ...
            <p className="information">
              A fullstack e-commerce app which takes a store full of items and
              the cart is updated. Registered users can then check out.
            </p>

            <div className="control">
              <button className="btn-b">
                <a
                  href="https://e-commercegeno.herokuapp.com/e-commerce1"
                  target="_blank"
                >
                  <span className="buy">Visit Site</span>
                </a>
              ...
              <button className="btn">
                <a
                  href="https://github.com/genosynth/e-commerce1"
                  target="_blank"
                  className="btn "
                >
                  {" "}
          ...
          <div className="project-image">
            <img src={commerceImage} alt="e-commerce thumbnail"></img>
        ...
        <div id="container">
          <div className="project-details">
            ...
            <div className="control">
              <button className="btn-b">
                <a href="https://pulagenju.herokuapp.com/" target="_blank">
                  <span className="buy">Visit Site</span>
                </a>
              </button>
              <button className="btn">
          ...
          <div className="project-image">
            <img src={pulaImage1} alt="postEdthumbnail"></img>
        ...
        <div id="container">
          ...
          <div className="project-image">
            <img src={todoListImage} alt="poolathumbnail"></img>
        ...
        <div id="container">
          <div className="project-details">
            ...
            <p className="information">
              A weather forecast application which makes API calls to{" "}
          ...
          <div className="project-image">
            <img src={weatherAppImage} alt="poolathumbnail"></img>
        ...
        <div id="container">
          <div className="project-details">
            ...
            <p className="information">
              An application used to aid in a live poker tournament with blind
              levels, players and other statistics.
            </p>

            <div className="control">
              <button className="btn-b">
                <a
                  href="https://genosynth.github.io/PokerClubApp/"
                  target="_blank"
                >
                  <span className="buy">Visit Site</span>
                </a>
              ...
              <button className="btn">
                <a
                  href="https://github.com/genosynth/PokerClubApp"
                  target="_blank"
                  className="btn "
                >
                  {" "}
          ...
          <div className="project-image">
            <img src={pokerApp} alt="pokerapp-thumbnail"></img>
